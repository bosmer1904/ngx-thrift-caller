...
@Injectable()
export class BufferHttpXhrBackend implements HttpBackend {
  ...
  handle(req: HttpRequest<any>): Observable<HttpEvent<any>> {
    ...
    return new Observable((observer: Observer<HttpEvent<any>>) => {
      ...
      let reqBody;
      // Don`t serialize body if it`s Uint8Array for send pure binary data
      // Serialize the request body if one is present. If not, this will be set to null.
      reqBody = req.body instanceof Uint8Array ? req.body : req.serializeBody();
